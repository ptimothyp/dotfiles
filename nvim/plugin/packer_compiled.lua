...
_G.packer_plugins = {
  ...
  ["coc.nvim"] = {
    loaded = true,
    path = "/Users/timothy/.local/share/nvim/site/pack/packer/start/coc.nvim",
  ...
  syntastic = {
    loaded = true,
    path = "/Users/timothy/.local/share/nvim/site/pack/packer/start/syntastic",
  ...
  ["vim-commentary"] = {
    loaded = true,
    path = "/Users/timothy/.local/share/nvim/site/pack/packer/start/vim-commentary",
